...
public class PostgresqlQuery {
    ...
    private String PSQL1 = "SELECT AVG(c.salaire) AS moyenne_salaires FROM employe e JOIN contrat_duree_indeterminee c ON e.id_employe = c.id_employe WHERE (CURRENT_DATE - e.date_de_naissance) BETWEEN 7300 AND 10950;";
