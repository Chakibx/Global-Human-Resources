--1 le cout total des formations de l'annee derniere(2)
...
--2 Moyenne du salaire des employes ages entre 20 et 30 ans.
...
--4 Le poste le plus performant de chaque departement avec le nom de l'emplyes et sa note (3)
...
--5 le nombre d'absence dans le departement ventes et marketing avec motif formation
...
--6 les employes avec leur poste et departement qui possede comme moyenne de performance <=12 pour effectuer des formations
...
--9 le nom, la derniere performance, et le poste de l'employé qui a eu la plus grosse augmentation de salaire
...
--10 tous les employes qui ont une aaugmentation de salaire <=700 et une performance <=15
